...
class Customer_form(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['verified_type'].widget = forms.Select(choices=self.VERIFIED_TYPE_CHOICES)
        self.fields['verified_type'].widget.attrs['placeholder'] = 'Select verification type'
