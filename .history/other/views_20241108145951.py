...
def transaction_details(request):
    ...
    context = {
        'transactions': transactions,
            "category":category}
    return render(request, 'other/details_transaction.html', content)
...
def create_transaction(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('details_transaction')
    else:
        form = TransactionForm()
    return render(request, 'other/create_transaction.html', {'form': form})
...
def update_transaction(request,pk):
    ...
    return render(request, 'other/update_transaction.html', {'form': form})
