...
urlpatterns = [
    ...
    path('details_fe/', views.fe_details, name='details_fe'),
    path('create_fe/', views.create_fe, name='create_fe'),
    path('update_fe/<int:pk>/', views.update_fe, name='update_fe'),
    path('delete_fe/<str:pk>/', views.delete_fe, name='delete_paymentType'),
