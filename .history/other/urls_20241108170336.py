...
urlpatterns = [
    ...
    path('details_feature/', views.feature_details, name='details_feature'),
    path('create_feature/', views.create_feature, name='create_feature'),
    path('update_feature/<int:pk>/', views.update_feature, name='update_feature'),
    path('delete_feature/<str:pk>/', views.delete_feature, name='delete_paymentType'),
