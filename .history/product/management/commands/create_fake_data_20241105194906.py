...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Step 1: Create States, Categories, and Payment Types
        for _ in range(10):
            State.objects.create(name=fake.state())
            Category.objects.create(name=fake.word(), description=fake.sentence())
            PaymentType.objects.create(name=fake.word())
            Features.objects.create(name=fake.word())

        # Step 2: Create Users and Customers
        for _ in range(50):
