...
def product_details(request, product_id):
    ...
    suggested_products = Product.objects.all().order_by('id')
    suggest_productimage = {}
    for sugge_product in suggested_products:
        images = ProductImage.objects.filter(product=sugge_product)
        suggest_productimage[sugge_product.id] = [image.image for image in images]  # Store list of images
    
    context = {
        'product': product,
        'product_images_all': images_queryset,  
        "suggested_products": suggested_products,
        "suggest_productimage": suggest_productimage,
    }
