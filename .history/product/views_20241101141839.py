...
def product_details(request, product_id):
    ...
    suggested_products = Product.objects.exclude(id=product.id)[:5]  # Fetch up to 5 suggested products

    # Prepare a dictionary mapping product IDs to image URLs (or None if no images)
