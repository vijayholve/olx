...
class Order(models.Model):
    ...
    payment_type = models.ForeignKey(payment_type,on_delete=models.CASCADE)  # e.g., Credit Card, PayPal, etc.
    ...
    payment_status = models.models.BooleanField(_(""))(max_length=50)  # e.g., Paid, Pending, Failed
