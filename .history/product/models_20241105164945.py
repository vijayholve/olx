...
class Plan( models.Model):
    ...
    plan_type = models.CharField(max_length=10, choices=CONDITION_CHOICES)
    features=models.ForeignKey(Features,on_delete=models.CASCADE, related_)
...
class Order(models.Model):
    ...
    payment_status = models.BooleanField()  # e.g., Paid, Pending, Failed
